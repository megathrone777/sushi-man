...
const SvgExclamationIcon: React.FC = () => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
  ...
  >
    <path
      ...
      5.591 11.401 11.985 11.401h41.17c6.394 0 11.666-5.014 11.985-11.401l6.8-136c.343-6.854-5.122-12.599-11.985-12.599h-54.77c-6.863 0-12.328 5.745-11.985 12.599z"
    />
  </svg>
);

export { SvgExclamationIcon };
